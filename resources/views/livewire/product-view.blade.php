            ...
            <div class="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
                ...
                <div class="mt-8 lg:col-span-5">
                    <form>
                        ...
                        <button type="button" wire:click="addToCart()" @if($size_id == null || $colour_id == null) disabled @endif
                                class="@if($size_id == null || $colour_id == null) opacity-25 cursor-not-allowed @endif mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                            Add to cart
                        </button>
                    </form>
